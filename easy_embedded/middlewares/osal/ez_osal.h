...
typedef ezOsal_TimerHandle_t (*ezOsal_pfTimerCreate)(const char* timer_name, uint32_t period_ticks, ezOsal_fpTimerElapseCallback timer_callback, void *argument);
